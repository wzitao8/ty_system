...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    商品筛选
    <div class="layui-input-inline">
        <button class="layui-btn" lay-submit lay-filter="formDemo" id="new" value="1">新品</button>
        <button class="layui-btn" lay-submit lay-filter="formDemo" id="hots" value="2">精品</button>
    </div>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<button class="layui-btn" lay-submit lay-filter="formDemo" id="price" value="2">价格升序倒叙</button>
...
<script type="text/javascript">
    $(function () {
        ...
        $('#demo1').click(function () {
            ...
            $.post(
                "http://pass.1810shop.com/api/goodsname",
        ...
        $('#price').click(function () {
            $.post(
                "http://pass.1810shop.com/api/price",
